...
const AdminLayout: FC<LayoutProps> = ({ children }) => {
  ...
  const [pendingApprovalsCount, setGeneralApprovalsCount] = useState(0);
  ...
  const baseAdminNavItems = [
    ...
    { href: '/admin/approvals', label: 'Account Approvals', icon: ClipboardCheck, roles: ['Admin'], count: pendingApprovalsCount },
